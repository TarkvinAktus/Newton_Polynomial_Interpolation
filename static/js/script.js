...
//Some global vars
//Sorry about that (._.)
var c_col = document.getElementById("canvas-col").getBoundingClientRect()


canvas.height = 700;
canvas.width  = c_col.right-c_col.left;
...
function loadData() {
    ...
    xhttp.open("GET", "http://192.168.0.77:9000/Newton?"+params, true);
    xhttp.send(); 
}
